...
/**
 * Created by kqw on 2016/8/2. WifiManager :
 ...
 * WifiInfo :
 * https://developer.android.com/reference/android/net/wifi/WifiInfo.html Wifi管理
 */
...
//                            break;
	 ...
	 */
	public boolean isConnectSSID(ScanResult result) {
		if (result == null) {
			return false;
		}
